...
//	Calling new methods getDailyService()
	...
	System.out.println(" HelloSpring App using DependencyInjection Type Constructor Injection in ClassPathXmlApplicationContext for Class TrackCourse BeanId: myCourse:" +theCourse.getDailyService());
